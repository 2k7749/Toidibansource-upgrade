               ...
               <div class="col-md-5 p-5 bg-white full-height">
                  <div class="login-main-left">
                     <div class="text-center mb-5 login-main-left-header pt-4">
                        ...
                        <p><?php echo $web["alertreg"]; ?></p>
                     </div>
                     <?php
                     require_once("libraries/class.database.php");
                     require "models/crypt_hipz.php";
                     if (isset($_POST["btn_submit"])) {
                        //lấy thông tin từ các form bằng phương thức POST htmlspecialchars Convert dạng thô
                        ...
                        if ($username == "" || $password == "" || $name == "" || $email == "") {
                           echo '
    <script type="text/javascript">toastr.warning("Please Do not leave blank", "Warning");</script>
			';
                        } else {
                           // Kiểm tra tài khoản đã tồn tại chưa
                           $sql = "select * from users where username='$username'";
                           $sql_mail = "select * from users where email='$email'";
                           $query_sql_mail = $csdl->query($sql_mail);
                           $kt = $csdl->query($sql);
                           if ($csdl->num_row($kt)  > 0) {
                              echo '
			       <script type="text/javascript">toastr.error("The Username has been created before", "Error");</script>
			            ';
                           } else if ($csdl->num_row($query_sql_mail)  > 0) {
                              echo '
			       <script type="text/javascript">toastr.error("Email address already exists", "Error");</script>
                     ';
                           } else if (strlen($username) < 6 || strlen($username) > 30) {
                              echo '
                  <script type="text/javascript">toastr.warning("Username must be between 6 - 30 characters", "Warning");</script>
                       ';
                           } else if (strlen($password) < 8 || strlen($password) > 30) {
                              echo '
                  <script type="text/javascript">toastr.warning("Password must be between 8 - 30 characters", "Warning");</script>
                       ';
                           } else if (strlen($name) < 6 || strlen($name) > 50) {
                              echo '
                  <script type="text/javascript">toastr.warning("Name must be between 6 - 50 characters", "Warning");</script>
                       ';
                           } else if (strlen($email) < 2 || strlen($email) > 50) {
                              echo '
                  <script type="text/javascript">toastr.warning("Email must be less than 50 characters ", "Warning");</script>
                       ';
                           } else if (!preg_match("/^[^@]+@[^@]+\.[a-z]{2,6}$/i", $email)) {
                              echo '
                  <script type="text/javascript">toastr.warning("Invalid email", "Warning");</script>
                       ';
                           } else {
                              $do_en_pass = Encrypt_Pass($password);
							...
							'basic',
							 ...
							 0,
							 0,
							 'https://i.imgur.com/LlP9ROo.png'
								    					)";
                              $csdl->query($sql);
                              echo '
			 <script type="text/javascript">toastr.success("Account registration successful, Login To Continute", "Success");</script>
			';
                           }
                        }
                     }
                     ...
                     <?php if ($web['accessreg'] == 0) { ?>
                        <form action="signup.html" method="post" id="signup">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" name="email" class="form-control" placeholder="Enter Your Gmail">
                           </div>
                           <div class="mt-4">
                              <button name="btn_submit" type="submit" class="btn btn-outline-primary btn-block btn-lg">Sign Up</button>
                           </div>
                        </form>
                     ...
                     <div class="owl-carousel owl-carousel-login">
                        <div class="item">
                           <div class="carousel-login-card text-center">
                              <img src="https://image.made-in-china.com/2f0j10IalGNmWDEZoB/Greenville-Fish-Game-USA-King-.jpg" class="img-fluid" alt="LOGO">
                        ...
                        <div class="item">
                           <div class="carousel-login-card text-center">
                              <img src="https://i.imgur.com/4692bOY.jpg" class="img-fluid" alt="LOGO">
                        ...
                        <div class="item">
                           <div class="carousel-login-card text-center">
                              <img src="https://i.imgur.com/JVFNiwD.png" class="img-fluid" alt="LOGO">
