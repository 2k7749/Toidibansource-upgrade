...
<html lang="en">
   ...
   <?php ;}?>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav mr-auto">
                        ...
                        <?php
                           ...
                           ?>
						   <?php $strlow = strtolower($cate["catename"]); $actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; $pos = strpos($actual_link, $strlow);?>
                        <li class="nav-item <?php if($pos == false){echo "";}else{echo "active";} ?>">
            ...
            <?php require_once("models/load_selectcate.php"); ?>
            <!-- /.end-container-fluid -->
