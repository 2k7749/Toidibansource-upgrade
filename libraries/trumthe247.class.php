...
class Trumthe247 {
	private $API_KEY = '235d2e8092d7ec5afbf7fe285113d55d'; //Api Key của tài khoản quý khách trên hệ thống TRUMTHE247.COM
	private $API_SECRET = '51ec073c68fe9d3e130e137f6652e63e'; //Api Serect của tài khoản quý khách trên hệ thống TRUMTHE247.COM
	...
	public function WriteLog($file_name, $content) { //Hàm xử lý việc ghi file log.
		...
		$fp = fopen(__DIR__ .'/../models/'.$file_name, 'a');
